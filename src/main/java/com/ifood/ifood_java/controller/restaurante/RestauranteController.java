...
public class RestauranteController {
    ...
    @PostMapping
    public ResponseEntity<RestauranteRequest> criarRestaurante(@Valid @RequestBody RestauranteRequest request){
        RestauranteRequest adicionar = restauranteService.criarRestaurante(request);
